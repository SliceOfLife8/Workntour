...
//  Networking
//
//  Created by Chris Petimezas on 25/11/22.
//
...
public struct MultipartForm: Hashable, Equatable {
    ...
    public func bodyData(_ profileData: Data) -> Data {
        var body = Data()
        body.append("--\(self.boundary)\r\n")
        body.append("Content-Disposition: form-data; name=\"updatedTravelerProfile\"")
        body.append("\r\n")
