...
extension PresentationCoordinator {
    ...
    public var _rootViewController: UIViewController { return rootViewController }
...
extension PresentationCoordinator {
    ...
    public func presentCoordinator(_ childCoordinator: _PresentationCoordinator, modalStyle: UIModalPresentationStyle = .automatic, animated: Bool) {
    ...
    public func dismissCoordinator(_ childCoordinator: _PresentationCoordinator, modalStyle: UIModalTransitionStyle = .coverVertical, animated: Bool, completion: (() -> Void)? = nil) {
...
extension NavigationCoordinator {
    ...
    public func pushCoordinator(_ childCoordinator: _PresentationCoordinator, animated: Bool) {
        addChildCoordinator(childCoordinator)
        childCoordinator.start()
